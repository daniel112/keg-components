import React, { isValidElement, useMemo, useState, useLayoutEffect, useEffect, forwardRef, useRef, useCallback } from 'react';
import PropTypes from 'prop-types';
import { helpers as helpers$1, useTheme, withTheme, useThemeHover, useThemeActive } from '@simpleviewinc/re-theme';
import { isFunc, isArr, isObj, isStr, get as get$1, reduceObj, deepMerge as deepMerge$1, validate, flatMap, mapEntries, isEmptyColl, jsonEqual, checkCall, logData, toBool, isNum, pickKeys, trainCase, capitalize } from 'jsutils';
import { View as View$1, Dimensions, Animated, Text as Text$2, Platform, TouchableNativeFeedback, TouchableOpacity, TouchableWithoutFeedback, Clipboard, ActivityIndicator, Image as Image$1, TextInput, Picker, Switch as Switch$1, Linking } from 'react-native';
...
var Side = function Side(props) {
  ...
  var contentStyles = get$1(style, [position, 'content', 'main']);
  var iconProps = {
    style: style,
    iconName: iconName,
    position: position
  ...
  return React.createElement(View, {
    ...
    style: get$1(style, [position, 'main'])
...
var CustomIcon = function CustomIcon(props) {
  ...
  return React.createElement(Icon, {
    name: iconName,
    styles: get$1(style, [position, 'content', 'icon'])
  });
};
...
var useCheckedState = function useCheckedState(isChecked, themeStyles) {
  ...
  return useMemo(function () {
    return theme.join(themeStyles, {
      area: _objectSpread2(_objectSpread2({}, get$1(themeStyles, 'area.off')), isChecked && get$1(themeStyles, 'area.on')),
      indicator: _objectSpread2(_objectSpread2({}, get$1(themeStyles, 'indicator.off')), isChecked && get$1(themeStyles, 'indicator.on'))
    });
  }, [isChecked]);
};
...
var Element$3 = withTheme(function (props) {
...
var Element$5 = forwardRef(function (_ref, ref) {
  var elProps = _ref.elProps,
...
export { Link as A, AppHeader, Button, Caption, Card, Checkbox, Column, Divider, Drawer, FilePicker, Form, Grid, H1, H2, H3, H4, H5, H6, Icon, Image, Input, Label, Link, Loading, Modal, Option, P, Radio, Row, Section, Select, Subtitle, Switch, Text, TextBox, TouchableIcon, View, theme };
